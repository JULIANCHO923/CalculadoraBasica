...
public class CalculadoraTest extends TestCase {
    ...
    public void testMultiplicacion() {
        ...
        esperaba: "+resultadoEsperado + " resulto:" +resultadoActual,resultadoEsperado,resultadoActual,deltaEsperado);
        }
    ...
    public void testDivision() {
        ...
        "+resultadoEsperado + " resulto:" +resultadoActual,resultadoEsperado,resultadoActual,deltaEsperado);
    }   
