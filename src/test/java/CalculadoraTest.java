...
public class CalculadoraTest extends TestCase {
	...
	public void testMultiplicacion() {
        ...
        //Assert
        Assert.assertEquals("La multiplicacion realizada no coincide: Se esperaba: "+resultadoEsperado + " resulto:" + resultadoActual,resultadoEsperado,resultadoActual,deltaEsperado);
    }
