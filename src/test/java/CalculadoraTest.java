...
public void testMultiplicacion() {
    ...
    //Assert
    Assert.assertEquals("La multiplicacion realizada no coincide: Se esperaba: "+resultadoEsperado + " resultado:" + resultadoActual, resultadoEsperado, resultadoActual, deltaEsperado);
}
...
public void testDivision() {
    ...
    //Assert
    Assert.assertEquals("La division realizada no coincide: Se esperaba: "+resultadoEsperado + " resultado:" + resultadoActual, resultadoEsperado, resultadoActual, deltaEsperado);
}
